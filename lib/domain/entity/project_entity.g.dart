...
void _projectEntityAttach(
  ...
  object.id = id;
  object.todos.attach(col, col.isar.collection<TodoEntity>(), r'todos', id);
}
...
extension ProjectEntityQueryLinks
    on QueryBuilder<ProjectEntity, ProjectEntity, QFilterCondition> {
  QueryBuilder<ProjectEntity, ProjectEntity, QAfterFilterCondition> todos(
    FilterQuery<TodoEntity> q,
  ) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectEntity, ProjectEntity, QAfterFilterCondition>
  todosLengthLessThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ProjectEntity, ProjectEntity, QAfterFilterCondition>
  todosLengthGreaterThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
